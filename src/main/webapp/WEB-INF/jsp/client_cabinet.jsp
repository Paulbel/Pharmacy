        ...
        <c:if test="${requestScope.prev_command eq 'get_order_list_enter_cabinet'}">
            <table border="1" cellpadding="5" cellspacing="5">
                ...
                <c:forEach var="item" items="${requestScope.order_list}">
                    <tr>
                        <td><c:out value="${item.drug.name}"/></td>
            ...
            <ul class="pagination">
                ...
                <c:choose>
                    <c:when test="${requestScope.currentPage != 1}">
                        <li>
                            <a href="FrontController?command=get_order_list_enter_cabinet&page=${requestScope.currentPage - 1}">«</a>
                        </li>
                    </c:when>
                    <c:otherwise>
                        <li class="disabled"><a href="#">«</a></li>
                ...
                <c:forEach begin="1" end="${requestScope.noOfPages}" var="i">
                    <c:choose>
                        ...
                        <c:otherwise>
                            <li><a href="FrontController?command=get_order_list_enter_cabinet&page=${i}"><c:out
                                    value="${i}"/></a>
                            </li>
                        </c:otherwise>
                    </c:choose>
